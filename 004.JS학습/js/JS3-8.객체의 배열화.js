...
// 1. 요구사항 분석
// - 제이슨 파일 영화 데이터를 바탕으로 각 영화의 정보를
//   화면에 박스구성하여 반복데이터를 코드로 생성한다!

// 2. 대상선정  
// 2-1. 이벤트 대상 : window(윈도우가 로딩됬을 때)
// -> 이벤트 종류 : load이벤트
...
function makeList(){
    ...
    // *********** 여기서 부터 다르다!!!! ************/
    // for in 안쓰고 배열 메서드인 forEach를 쓰려고함!
    ...
    // for in문으로 돌린것처럼 key값을 순회하여 셋팅가능함!
          ...
          <section class="cbx">
            <div class="minfo">
              ...
              <div class="cont">
                ...
                <!-- 4. 감독 -->
                <h3 class="dir">★감독 : ${movieInfo[x]['감독']}
                </h3>
                <!-- 5. 출연 -->
                <h3 class="act">
                  ★배우 : ${movieInfo[x]['출연']}
